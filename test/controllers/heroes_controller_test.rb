...
class HeroesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference("Hero.count") do
      post heroes_url, params: { hero: { gender: @hero.gender, name: @hero.name, universe_id: @hero.universe_id } }, as: :json
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { gender: @hero.gender, name: @hero.name, universe_id: @hero.universe_id } }, as: :json
    assert_response :success
  end
